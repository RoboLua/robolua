# Credit to @qhdwight for his deps fetching
...
export CC := $(HOME)/.gradle/toolchains/frc/2024/roborio/bin/arm-frc2024-linux-gnueabi-gcc
export CXX := $(HOME)/.gradle/toolchains/frc/2024/roborio/bin/arm-frc2024-linux-gnueabi-g++
# Update if newer WPILib version
WPI_LIB_VER := 2024.3.2
NI_LIB_VER := 2024.2.1
